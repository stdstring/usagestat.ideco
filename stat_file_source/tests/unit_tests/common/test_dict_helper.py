...
class TestDictHelper(TestCase):
    ...
    def test_get(self):
        ...
        self.assertEqual('some_value', DictHelper.get_or_create(source_dict, 'some_key', 'default_value'))
        self.assertDictEqual({'some_key': 'some_value'}, source_dict)

    def test_create(self):
        source_dict = {'some_key': 'some_value'}
        self.assertEqual('default_value', DictHelper.get_or_create(source_dict, 'other_key', 'default_value'))
